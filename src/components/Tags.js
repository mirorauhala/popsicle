...
export default function Tags(props) {
    ...
    const isValidNewOption = (inputValue) => {
        ...
        return !tags.findIndex(tag => tag.name.toLowerCase() !== inputValue.toLowerCase())
    }
    ...
    const customStyles = {
        ...
        menu: (provided) => {
            return {
                ...
                boxShadow: "0 20px 25px -5px rgb(55 48 163 / 0.2), 0 8px 10px -6px rgb(55 48 163 / 0.2)",
                padding: "0.5rem"
            }
        },
        menuList: (provided) => {
    ...
    const noOptionsMessage = () => "Create new tags by typing and hitting return."
