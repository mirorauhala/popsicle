        ...
        >
          ...
          >
            ...
            <h1 className="flex flex-wrap flex-col mb-5">
              <span className="font-medium uppercase tracking-wide text-sm text-indigo-500">Set an alarm for task</span>
              <span className="font-black text-3xl text-indigo-900">{task.body}</span>
            </h1>

            {
              task.done ? (
                <>
                  <p className="mb-3 bg-amber-50 text-amber-600 border-amber-200 border-2 px-3 py-1 font-medium rounded-lg">This task is marked as done. Tasks marked as done cannot have an alarm.</p>
                ...
                <>
                  ...
                  <Button onClick={handleNotificationGrant}>Grant permissions</Button>
                </>
              ) : (
                <form
                ...
                >
                  <p className="rounded-lg px-3 py-1 mb-3 text-red-600 bg-red-50 border-red-200 border-2 font-medium empty:hidden">{error}</p>
...

          {
            isMenuOpen
              ? (
                <div ref={menuRef} className="flex flex-col border border-indigo-900/10 px-2 py-3 rounded-lg absolute bg-white w-30 top-[46px] right-0 z-50 shadow-xl shadow-indigo-800/20">
                  <button
